...
var IndirectProcessModule = require('../../modules/sapsan/indirect-process/main.js');
module.exports = {
    controller: function () {
        Globals.isAuth();
        ...
        return {
            ...
            upload: function () {
			var indirectProcessModule = new IndirectProcessModule;
                indirectProcessModule.init();
