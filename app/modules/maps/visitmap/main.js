...
module.exports = function (config) {
    ...
    function searchByYandex(){
        var address = 'Казахстан, '+Model.salepoint['LOC_NAME']+', '+Model.salepoint['SAL_NOTES']+', '+Model.salepoint['SAL_HOUSE'];
    ...
    function view(ctrl) {
        switch(_state){
            case 'loading':
                return m("div", {class: "m-map-visit"}, [
                    new ModalLoading({header: "Загрузка данных"})
                ])
            break;
            case 'locator':
                return m("div", {class: "m-map-visit"}, [
                    m("div", {class: "m-map-visit__map-container", id: "locatorMapContainer", config: initMap}, ''),
            ...
            case 'error':
                return m("div", {class: "m-map-visit"},
                    m("div", {class: "m-map-visit__error-container alert"},
